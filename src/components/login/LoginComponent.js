...
class LoginComponent extends Component {
    ...
    userLoginHandler(e){
        axios({
            ...
            localStorage.setItem("id", response.data.sessionDomain.userId);
            localStorage.setItem("token", response.data.sessionDomain.token);
    ...
    render() { 
        return (
            ...
            <Container>
                <center>
                    <h2 className="sign-up-main-text"><strong>Login</strong></h2>
                    <Form onSubmit={function(e){
                        ...
                        <div className="join-us-form-button-aria">
                            <span className="button-box">
                                <button className="basic-button" type="submit">로그인</button>
                            </span>
                        </div>
                    </Form>
                </center>
